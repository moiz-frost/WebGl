...
var init = function () {
    ...
    mat4.identity(worldMatrix); // converts 1D array into a 4x4 matrix
    mat4.identity(viewMatrix); // converts 1D array into a 4x4 matrix
    mat4.identity(projMatrix); // converts 1D array into a 4x4 matrix
