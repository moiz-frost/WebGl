...
var vertexShaderText =
    [
        ...
        '',
        'attribute vec3 vertPosition;', // postition vector
        '',
...
var init = function () {
    ...
    var trianglePoints =
        [// x       y       z       r       g       b
            -0.5,   0.5,    0.0,    1.0,    1.0,    1.0,  // A
            0.5,    0.5,    0.0,    1.0,    1.0,    1.0,  // B
            0.5,    -0.5,   0.0,    1.0,    1.0,    1.0,  // C
            -0.5,   0.5,    0.0,    1.0,    1.0,    1.0,  // A
            -0.5,   -0.5,   0.0,    1.0,    1.0,    1.0,  // D
            0.5,    -0.5,   0.0,    1.0,    1.0,    1.0   // C
        ];
    ...
    gl.drawArrays(gl.TRIANGLES, 0, 6); // 0 = no of elements to skip, 3 = no of vertices to draw
